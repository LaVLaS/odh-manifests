...
function test_start_notebook() {
    ...
    os::cmd::expect_success "run_robot_test.sh --test-case tests/Tests/test-jupyterlab-notebook.robot --test-variables-file ${MY_DIR}/../resources/ods-ci/test-variables.yml --test-variable OCP_DASHBOARD_URL=${dashboard_route}"
}
